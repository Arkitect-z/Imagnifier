...
from experiments.waifu2x_chainer.lib import iproc
from experiments.waifu2x_chainer.lib import reconstruct
from experiments.waifu2x_chainer.lib import srcnn
from experiments.waifu2x_chainer.lib import utils
...
def load_models(cfg):
    ...
    if cfg.model_dir is None:
        model_dir = os.getcwd() + '/BackEnd/experiments/waifu2x_chainer/models/{}'.format(cfg.arch.lower())
    else:
...
def main(parser):
    ...
    args = p.parse_args()
    args.input = parser["input_file_path"]
    args.output = parser["output_file_path"]
    args.method = "scale"
    args.arch = "0"
